...
# Import settings and metadata. Importing app.models registers every model
# on Base.metadata so autogenerate can see them.
from app.core.config import settings
from app.core.eventloop import use_selector_event_loop_on_windows
from app.db.base import Base
import app.models  # noqa: F401

# psycopg3 async needs a SelectorEventLoop on Windows.
